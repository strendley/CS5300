...
ALTER TABLE GCWZF4.PUBLISHER_BOOKS
ADD TITLE VARCHAR2(200);

ALTER TABLE GCWZF4.PUBLISHER_BOOKS
ADD AUTHOR VARCHAR2(100);

ALTER TABLE GCWZF4.PUBLISHER_BOOKS
ADD EDITION VARCHAR2(60);

ALTER TABLE GCWZF4.PUBLISHER_BOOKS
DROP CONSTRAINT PB_FK;
...
ADD CONSTRAINT PB_TO_P_FK
	FOREIGN KEY (PUBLISHER) REFERENCES GCWZF4.PUBLISHERS;

ALTER TABLE GCWZF4.PUBLISHER_BOOKS
ADD CONSTRAINT PB_TO_BE_FK
	FOREIGN KEY (TITLE, AUTHOR, EDITION) REFERENCES GCWZF4.BOOK_EDITIONS;
